...
namespace Valve.VR.InteractionSystem
{
	...
	public class Player : MonoBehaviour
	{
		...
		public SphereCollider realHeadCollider;
		...
		private void ActivateRig( GameObject rig )
		{
			...
			if ( audioListener )
			{
				...
				realHeadCollider.center = hmdTransform.position;
			}
		}

		public void HandCollisionEnter(GameObject hand, Collision collision) {
			Debug.Log(collision.gameObject.layer);
		}

		public void HandCollisionExit(GameObject hand, Collision collision) {
